globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/page-CMeOILXW.js","assets/layout-segment-context-BKBmHT0Y.js"];
...
function getDraftSecret() {
	return "36bc9a45-e6cf-4a2f-8e9b-dd1b8a72e4c8";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "f5d38631-2030-4d53-8edf-6ea1bcc8425b";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "f5d38631-2030-4d53-8edf-6ea1bcc8425b") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "f5d38631-2030-4d53-8edf-6ea1bcc8425b",
		rootBoundaryId
	});
}
/**
