...
function Home() {
	...
	const [openApp, setOpenApp] = (0, import_react.useState)(null);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(DesktopIcon, {
						...
						onClick: () => setOpenApp("readme")
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(DesktopIcon, {
						icon: "▣",
						label: "НАСЛЕДСТВО.arc",
						onClick: () => setOpenApp("archive")
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(DesktopIcon, {
						icon: "▧",
						label: "Мои файлы",
						onClick: () => setOpenApp("files")
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(DesktopIcon, {
						icon: "⌫",
						label: "Корзина",
			...
			openApp && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Window, {
				title: windowTitle(openApp),
				onClose: () => setOpenApp(null),
				children: [
					openApp === "readme" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Readme, { onContinue: () => setOpenApp("files") }),
					openApp === "files" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FileExplorer, {
						selected: selectedFile,
						setSelected: setSelectedFile,
						restored,
						openArchive: () => setOpenApp("archive")
					}),
					openApp === "terminal" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "terminal",
					...
					openApp === "archive" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Archive, {
						restored,
						code: archiveCode,
					...
					openApp === "log" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("pre", {
						className: "text-file",
						children: "[03:14:08] LOGIN unknown_17\\n[03:17:42] DELETE user_fragment.log\\n[03:18:01] LOCK inheritance.arc\\n[03:18:07] SESSION LOST"
					}),
					openApp === "help" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "document",
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("footer", {
				...
				children: [
					...
					openApp && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
						className: "task-button",
						onClick: () => setOpenApp(openApp),
						children: windowTitle(openApp)
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "tray",
...
function Readme({ onContinue }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "Не верь времени на экране. Смотри на то, что система пытается скрыть. Начни с повреждённой фотографии и журнала входов." }),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { children: [
				"Пароль от архива я не мог записать прямо. Подсказка была нашей ",
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("b", { children: "первой памятью" }),
				"."
			] }),
...
function FilePreview({ id, restored, openArchive }) {
	if (id === "photo") return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "03:14" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("i", { children: "DATA LOST" })]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("b", { children: "IMG_0314.corrupt" }) }),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { children: [
				"Дата создания повреждена. В уцелевшем фрагменте часов: ",
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("b", { children: "03:14" }),
				"."
			] })
		]
	});
	if (id === "note") return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "preview",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("b", { children: "заметка_без_даты.txt" }) }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "«Первое, что машина запомнила, — не лицо и не имя. Только время»." })]
	});
	if (id === "log") return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("b", { children: "system.log" }) }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("pre", { children: [
			"[03:14] login: unknown_17",
			`\n`,
			"[03:17] delete: user_fragment.log"
		] })]
	});
...
function Archive({ restored, code, setCode, unlock, done }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("small", { children: restored ? "Фрагмент ключа восстановлен: FIRST_MEMORY" : "В корзине обнаружен удалённый фрагмент. Его можно восстановить через терминал." })
		]
	});
}
//#endregion
