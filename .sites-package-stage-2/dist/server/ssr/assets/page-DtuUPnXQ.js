...
function Home() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
		...
		children: [
			...
			openApp && !minimized && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Window, {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("footer", {
				...
				children: [
					...
					openApp && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
						className: `task-button ${minimized ? "is-minimized" : "is-active"}`,
...
function Window({ title, onClose, onMinimize, children }) {
