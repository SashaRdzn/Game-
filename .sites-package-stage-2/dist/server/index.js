globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/page-m3oFzII6.js","assets/layout-segment-context-DLJF0EPr.js"];
...
function getDraftSecret() {
	return "0b0fae02-ffae-4c93-aeea-6b0d23ea6630";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "401b1664-d002-4bdd-955a-65d4a3862b40";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "401b1664-d002-4bdd-955a-65d4a3862b40") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "401b1664-d002-4bdd-955a-65d4a3862b40",
		rootBoundaryId
	});
}
/**
