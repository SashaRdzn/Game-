globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/page-qcur7iPj.js","assets/layout-segment-context-CjOsxWw1.js"];
...
function getDraftSecret() {
	return "35dfb375-5236-43ff-9cba-d72dcb42e6b3";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "eedb1230-bf76-4c1d-9c07-25ec61da5223";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "eedb1230-bf76-4c1d-9c07-25ec61da5223") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "eedb1230-bf76-4c1d-9c07-25ec61da5223",
		rootBoundaryId
	});
}
/**
