...
type BrowserView = "home" | "cloud" | "crypto" | "porno" | "notfound";
...
function Pikanichok({ page, navKey }: { page: "home" | "cloud" | "crypto"; navKey: number }) {
  ...
  function applyAddress(value: string) {
    ...
    const view: BrowserView = comparable === "pika://home" ? "home" : comparable === cloudAddress.replace(/\/$/, "") ? "cloud" : comparable === cryptoAddress.replace(/\/$/, "") ? "crypto" : comparable === pornoAddress ? "porno" : "notfound";
    const title = view === "home" ? "Pikanet" : view === "cloud" ? "ОблакоФото" : view === "crypto" ? "Crypto Wallet" : view === "porno" ? "PornoHub" : "Узел не найден";
