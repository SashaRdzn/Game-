globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/page-D5mmqldN.js","assets/layout-segment-context-C3cr485M.js"];
...
function getDraftSecret() {
	return "6f57345c-315e-48d2-8f23-ff2da66ac20e";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "cb8a60ff-ea2c-44ca-8916-e725677a749e";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "cb8a60ff-ea2c-44ca-8916-e725677a749e") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "cb8a60ff-ea2c-44ca-8916-e725677a749e",
		rootBoundaryId
	});
}
/**
